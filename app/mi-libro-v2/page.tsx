...
export default function MiLibroPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-red-50">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-orange-100 via-white to-red-100 py-12">
        <div className="container mx-auto flex flex-col md:flex-row items-center gap-8 px-4">
          ...
          <div className="w-full md:w-1/2 text-center md:text-left space-y-4">
            ...
            <h2 className="text-2xl font-semibold text-gray-800">Cambiar de trabajo y recuperar tu vida</h2>
            <p className="text-lg text-gray-700">
              <strong>Eliana Bracciaforte</strong>
            </p>
            <p className="text-xl">¿Y si renunciar no fuera el final, sino el comienzo?</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              <Button asChild size="lg" className="bg-orange-600 hover:bg-orange-700">
                <Link
                  href="https://www.galernaweb.com/productos/renuncio-eliana-bracciaforte/?utm_source=cronicaslaborales&utm_medium=website&utm_campaign=libro_renuncio&utm_content=hero_fisico"
                  target="_blank"
                >
              ...
              <Button asChild size="lg" variant="outline">
                <Link
                  href="https://www.amazon.com/Renuncio-Cambiar-trabajo-recuperar-Spanish-ebook/dp/B0FC364QY4/?utm_source=cronicaslaborales&utm_medium=website&utm_campaign=libro_renuncio&utm_content=hero_ebook"
                  target="_blank"
                >
                  <Smartphone className="mr-2 h-5 w-5" />E-book
                </Link>
              </Button>
            </div>
          </div>
